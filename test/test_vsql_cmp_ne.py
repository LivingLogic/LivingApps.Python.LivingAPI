...
def test_nulllist_nulllist2(config_persons):
	check_vsql(config_persons, "not ([None, None] != [None, None])")
...
def test_nullset_intset4(config_persons):
	check_vsql(config_persons, "{None, None} != {1, 2}")
...
def test_nullset_numberset4(config_persons):
	check_vsql(config_persons, "{None, None} != {1.1, 2.2}")
...
def test_nullset_strset4(config_persons):
	check_vsql(config_persons, "{None, None} != {'gurk', 'hurz'}")
...
def test_nullset_dateset4(config_persons):
	check_vsql(config_persons, "{None, None} != {@(2000-02-29), @(2000-03-01)}")
...
def test_nullset_datetimeset4(config_persons):
	check_vsql(config_persons, "{None, None} != {@(2000-02-29T12:34:56), @(2000-03-01T12:34:56)}")
...
def test_intset_nullset4(config_persons):
	check_vsql(config_persons, "{1, 2} != {None, None}")
...
def test_numberset_nullset4(config_persons):
	check_vsql(config_persons, "{1.1, 2.2} != {None, None}")
...
def test_strset_nullset4(config_persons):
	check_vsql(config_persons, "{'gurk', 'hurz'} != {None, None}")
...
def test_dateset_nullset4(config_persons):
	check_vsql(config_persons, "{@(2000-02-29), @(2000-03-01)} != {None, None}")
...
def test_datetimeset_nullset4(config_persons):
	check_vsql(config_persons, "{@(2000-02-29T12:34:56), @(2000-03-01T12:34:56)} != {None, None}")
