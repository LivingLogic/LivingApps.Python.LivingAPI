...
def test_bool_bool1(config_persons):
	check_vsql(config_persons, "app.p_int_none.value << False is None")
...
def test_int_bool(config_persons):
	check_vsql(config_persons, "2 << app.p_bool_true.value == 4")

def test_int_int(config_persons):
	check_vsql(config_persons, "-app.p_int_value.value << 2 == -7108")
