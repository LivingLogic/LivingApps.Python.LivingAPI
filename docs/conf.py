...
# -*- coding: utf-8 -*-
#
# LivingAPI documentation build configuration file.
#
...
project = 'LivingAPI'
copyright = '2017\N{EN DASH}2021, LivingLogic AG'
...
if os.path.exists("sphinx_ll_theme/static/fontawesome-pro-6.5.1-web"):
	html_theme_options = {
		"font_awesome_url": "../fontawesome-pro-6.5.1-web/css/all.min.css",
	...
	html_theme_options = {
		"font_awesome_url": "../fontawesome-free-6.5.1-web/css/all.min.css",
...
htmlhelp_basename = 'LivingAPIdoc'
...
latex_documents = [
	(master_doc, 'LivingAPI.tex', 'LivingAPI Documentation', 'Walter Dörwald', 'manual'),
]
...
man_pages = [
	(master_doc, 'livingapi', 'LivingAPI documentation', [author], 1)
]
...
texinfo_documents = [
	(master_doc, 'LivingAPI', 'LivingAPI documentation', author, 'LivingAPI', 'Python API for the LivingApps platform.', 'Miscellaneous'),
]
...
intersphinx_mapping = {
	...
	'xist': ('https://python.livinglogic.de/', None),
}
